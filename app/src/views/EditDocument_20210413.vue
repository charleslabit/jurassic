...
export default {
  ...
  methods: {
    printFile() {
      ...
      window.open(
        `initial_document/${this.selectedRule}?ja=${this.PersonInCharge}&category=${rulebookCategory}&koushin=${this.$route.query.koushin}`,
        `_blank`
      );
    },
    ...
    copyFileServer() {
      ...
      axios.get(url).then((res) => {
        ...
        let oldpath = `\\\\rndfsv01.hrd-s.com\\section2\\manual\\rulebook\\${koushin}\\${rulebookCategory}\\${Japanese}\\${this.selectedRule}.pdf`;
        let newpath = `\\\\rndfsv01.hrd-s.com\\section2\\manual\\rulebook\\${koushin}\\${newrulebookCategory}\\${Japanese}\\${this.selectedRule}.pdf`;
        const toInsertPath = {
          oldpath,
          newpath,
        };
    ...
    openFile() {
      ...
      axios.get(url).then((res) => {
        body = res.data
          ...
          .toString()
          .toLowerCase();
        let filePath = `${this.fileLister}ftp/RULEBOOK/${this.$route.query.koushin}/${rulebookCategory}/${body}/${this.selectedRule}.pdf`;
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          if (this.$route.query.kind == "After") {
            ...
            let urlDate = `${this.api}get/generated_documentno_final?&newDocumentNo=${this.selectedItem._id}&method=${this.selectedItem.method}`;
