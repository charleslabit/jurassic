          ...
          <v-row dense>
            ...
            <v-col cols="4" :sm="2" :md="2">
             ...
             <v-spacer v-if="!isFilterOn" />
                <a-button v-if="!isFilterOn" icon="filter" @click="hideFilter=!hideFilter">{{hideFilter? 'View Filter': 'Hide Filter'}} </a-button>
...
<!-- //FILTER -->
          <a-row :xs="24" :sm="12" :md="10" :gutter="[0, 3]" v-if="!isFilterOn && !hideFilter">
           ...
           <a-col :xs="24" :sm="7" :md="7">
            ...
            <a-col :xs="24" :sm="7" :md="5">
              <v-layout row wrap>
                <span class="button mt-1" v-if="sortByFavoriteASC == false" @click="
                        sortByFavoriteASC = true;
                        sortByFavoriteDES = false;
                      " > <v-icon color="white"> mdi-calendar-star </v-icon> 🔽
                
                </span>
                <span class="button mt-1" v-else  @click="
                        sortByFavoriteDES = true;
                        sortByFavoriteASC = false;
                      "  > <v-icon color="white"> mdi-calendar-star </v-icon> 🔼
