...
router.post("/save_edit_department", (req, res) => {
  const CURRENT_TIMESTAMP = moment().format("YYYY-MM-DD hh:mm:ss");
  let sql = `UPDATE t_InCharge
             SET DepartmentName = '${req.body.DepartmentName}', UpdatedDate = '${CURRENT_TIMESTAMP}' ,UpdatedBy = '${req.body.UpdatedBy}'
            WHERE DocumentNo = '${req.body.DocumentNo}' AND SeqNo = ${req.body.SeqNo}`
